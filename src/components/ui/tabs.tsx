...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-auto min-h-[2.75rem] items-center justify-start rounded-lg bg-muted p-1 text-muted-foreground flex-wrap gap-1",
      className
    )}
    {...props}
  />
